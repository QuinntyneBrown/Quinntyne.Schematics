...
{
    public class GenerateInterfaceCommand
    {
        ...
        public class Handler : IRequestHandler<Request>
        {
            ...
            {                
                ...
                var template = _templateLocator.Get("GenerateInterfaceCommand");
                ...
                _fileWriter.WriteAllLines($"{request.Directory}//{entityNameSnakeCase}.ts", result);
