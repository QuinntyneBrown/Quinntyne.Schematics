    ...
    public class GenerateEditOverlayComponentCommand
    {
        ...
        public class Handler : IRequestHandler<Request>
        {
            ...
            {                
                ...
                _fileWriter.WriteAllLines($"{request.Directory}//edit-{entityNameCamelCase}-overlay.component.ts", result);
                _fileWriter.WriteAllLines($"{request.Directory}//edit-{entityNameCamelCase}-overlay.component.html", new string[0]);
                _fileWriter.WriteAllLines($"{request.Directory}//edit-{entityNameCamelCase}-overlay.component.css", new string[0]);
