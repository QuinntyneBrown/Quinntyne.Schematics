...
{
    public class GenerateTestScenarioBaseCommand
    {
        ...
        public class Handler : IRequestHandler<Request>
        {
            ...
            public Task Handle(Request request, CancellationToken cancellationToken)
            {
                ...
                var template = _templateLocator.Get("GenerateTestScenarioBaseCommand");
                ...
                _fileWriter.WriteAllLines($"{request.Directory}//{entityNamePascalCase}ScenarioBase.cs", result);
