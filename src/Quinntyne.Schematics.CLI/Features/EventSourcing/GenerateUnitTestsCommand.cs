...
{
    public class GenerateUnitTestsCommand
    {
        ...
        public class Handler : IRequestHandler<Request>
        {
            ...
            {                
                ...
                var template = _templateLocator.Get("GenerateUnitTestsCommand");
                ...
                _fileWriter.WriteAllLines($"{request.Directory}//{entityNamePascalCase}UnitTests.cs", result);
