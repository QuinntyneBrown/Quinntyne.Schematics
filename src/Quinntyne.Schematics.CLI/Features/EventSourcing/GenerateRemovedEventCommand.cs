...
{
    public class GenerateRemovedEventCommand
    {
        ...
        public class Handler : IRequestHandler<Request>
        {
            ...
            {                
                ...
                var template = _templateLocator.Get("GenerateRemovedEventCommand");
                ...
                _fileWriter.WriteAllLines($"{request.Directory}//{entityNamePascalCase}RemovedEvent.cs", result);
