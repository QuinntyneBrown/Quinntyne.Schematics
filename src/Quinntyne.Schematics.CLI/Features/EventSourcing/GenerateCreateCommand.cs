...
{
    public class GenerateCreateCommand
    {
        ...
        public class Handler : IRequestHandler<Request>
        {
            ...
            public Task Handle(Request request, CancellationToken cancellationToken)
            {
                ...
                var template = _templateLocator.Get("GenerateCreateCommand");
                ...
                _fileWriter.WriteAllLines($"{request.Directory}//Create{entityNamePascalCase}Command.cs", result);
