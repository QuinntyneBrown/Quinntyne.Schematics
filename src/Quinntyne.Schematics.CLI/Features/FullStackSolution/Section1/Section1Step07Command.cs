...
{
    public class Section1Step07Command
    {
        ...
        public class Handler : IRequestHandler<Request>
        {
            ...
            {                
                ...
                var template = _templateLocator.Get("Section1Step07Command");
                ...
                _fileWriter.WriteAllLines($"{request.SolutionDirectory}//src//{request.RootNamespace}.Core//Models//NoteTag.cs", result);
