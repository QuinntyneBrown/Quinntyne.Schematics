...
{
    public class Section1Step06Command
    {
        ...
        public class Handler : IRequestHandler<Request>
        {
            ...
            {                
                ...
                var template = _templateLocator.Get("Section1Step06Command");
                ...
                _fileWriter.WriteAllLines($"{request.SolutionDirectory}//src//{request.RootNamespace}.Core//Models//Tag.cs", result);
