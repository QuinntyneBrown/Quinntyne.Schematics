...
{
    public class Section1Step03Command
    {
        ...
        public class Handler : IRequestHandler<Request>
        {
            ...
            {                
                ...
                var template = _templateLocator.Get("Section1Step03Command");
                ...
                _fileWriter.WriteAllLines($"{request.SolutionDirectory}//src//{request.RootNamespace}.Core//Common//DomainEvent.cs", result);
