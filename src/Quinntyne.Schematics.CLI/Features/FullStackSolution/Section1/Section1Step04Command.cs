...
{
    public class Section1Step04Command
    {
        ...
        public class Handler : IRequestHandler<Request>
        {
            ...
            {                
                ...
                var template = _templateLocator.Get("Section1Step04Command");
                ...
                _fileWriter.WriteAllLines($"{request.SolutionDirectory}//src//{request.RootNamespace}.Core//Common//Entity.cs", result);
